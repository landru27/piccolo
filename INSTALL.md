...
(Take [for example](https://stackoverflow.com/questions/19578796/what-is-the-save-option-for-npm-install), the countless JavaScript / Node.js examples that have you `npm install --save`.  The `--save` behavior is now the default behavior of `npm`, long enough ago that `npm` itself doesn't mention this (neither in its `--help` nor on its [doc page](https://docs.npmjs.com/cli/v6/commands/npm-install)).)
